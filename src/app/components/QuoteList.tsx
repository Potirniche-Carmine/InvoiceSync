...
export default function QuoteList() {
  ...
  const handleConvertToInvoice = (quoteId: string) => {
    ...
    // Instead of showing a dialog, we'll navigate directly to create-invoice with the quote data
    window.location.href = `/admin/dashboard/create-invoice?from_quote=${quoteId}`;
  };
